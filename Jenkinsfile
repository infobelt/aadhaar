        ...
        stage('CI Build and push snapshot') {
            ...
            steps {
                container('maven') {
                    ...
                    slackSend(color: 'green', message: "Aadhaar :: Starting PR build [${env.PREVIEW_VERSION}] (${env.BUILD_URL})")
        ...
        stage('Build Release') {
            ...
            steps {
                container('maven') {
                    ...
                    slackSend(color: 'good', message: "Aadhaar :: Building ${env.VERSION} (${env.BUILD_URL})")
